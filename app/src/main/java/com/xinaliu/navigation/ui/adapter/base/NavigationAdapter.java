 ...
 */
public abstract class NavigationAdapter<T> extends RecyclerView.Adapter<NavigationViewHolder> {
    ...
    public NavigationAdapter(List<T> mDatas, @LayoutRes int itemLayoutId) {
        this.mDatas = mDatas;
    ...
    public NavigationViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final NavigationViewHolder holder = new NavigationViewHolder(view, viewType);
    ...
    public  abstract void convert(NavigationViewHolder holder, T item, int position);
